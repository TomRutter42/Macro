# Solve Question 3 Using Endogenous Grid Method
...
C_with_loans = deepcopy(C)
## Save this consumption array to the /temp folder.
save("temp/C_with_loans.jld", "C_with_loans", C_with_loans)
...
plot!([L_t, ymax], [0, ymax - L_t], label = "45 Degree Line subtract L_t", 
      linestyle = :dash, color = :pink)

savefig("figures/ConsumptionFunctionAge25vs30_WITH_LOAN.png")